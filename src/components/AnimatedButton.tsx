...
export function AnimatedButton({
  ...
  const baseStyles = cn(
    ...
    {
      'bg-exvia-black text-white hover:bg-exvia-base-black': variant === 'primary' && !disabled,
      'bg-white text-exvia-black border border-exvia-border hover:border-exvia-black': variant === 'secondary' && !disabled,
      'bg-transparent text-exvia-black border border-exvia-black hover:bg-exvia-black hover:text-white': variant === 'outline' && !disabled,
      'bg-transparent text-white border border-white/60 hover:bg-white hover:text-exvia-black': variant === 'outline-white' && !disabled,
